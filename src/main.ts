...
async function bootstrap() {
  ...
  app.use((req: Request, res: Response, next: NextFunction) => {
    const allowedOrigins = ['http://127.0.0.1:5500','http://127.0.0.1:5502', 'http://127.0.0.1:5501', 'https://beks-coding-club-foundation-track.vercel.app', 'https://beks-coding-club-foundation-track-9js7vu8ev.vercel.app'];
